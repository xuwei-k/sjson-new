...
class CaseClassFormatsSpec extends Specification with BasicJsonProtocol {
  ...
  "case class Json Object Format" should {
    implicit val instance: JsonFormat[Foo] =
      BasicJsonProtocol.caseClass(Foo.apply _, x => Option((x.a, x.b)))("a", "b")
  ...
  "case class Json Array Format" should {
    implicit val instance: JsonFormat[Foo] =
      BasicJsonProtocol.caseClassArray(Foo.apply _, x => Option((x.a, x.b)))
  ...
  "case class with 1 field" should {
    implicit val jf: JsonFormat[Uno] = BasicJsonProtocol.caseClass(Uno.apply _, x => Option(x.a))("a")
  ...
  "case class with 1 field" should {
    implicit val jf: JsonFormat[Uno] = BasicJsonProtocol.caseClassArray(Uno.apply _, x => Option(x.a))
